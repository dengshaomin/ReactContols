...
import {
  ...
  Text,
  ActivityIndicator,
  View, Image, InteractionManager, ToastAndroid
} from 'react-native';
...
export default class RefreshListViewComponent extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    if (this._loadingStatu == types.ListViewStatus.FINISH && render && this.refs.ptr != null) this.refs.ptr.refreshComplete();
    console.log(this._loadingStatu);
    return render;
  }
