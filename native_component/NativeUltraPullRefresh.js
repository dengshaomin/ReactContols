...
export default class NativePtrAndroidComponent extends Component {
    constructor(props) {
        super(props);
...
NativePtrAndroidComponent.name = "NativePtrAndroid"; //便于调试时显示(可以设置为任意字符串)
NativePtrAndroidComponent.propTypes = {
...
const NativePtrAndroid = requireNativeComponent('NativePtrAndroid', NativePtrAndroidComponent, {nativeOnly: {onPtrRefresh: true}});