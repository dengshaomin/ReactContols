...
export default class TeamDetailPlayer extends React.Component {
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.portrait}>
                        <View style={styles.portraitBackground}>
                            <Image style={[styles.portraitImage, {borderColor: teamMap.color}]}
                                   source={{uri: `http://stats.nba.com/media/players/230x185/${player.id}.png`}}/>
                        </View>
                    </View>
