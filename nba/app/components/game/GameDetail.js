            ...
            <View style={{flex: 1}}>
                ...
                <View style={styles.segment}>
                    <TouchableHighlight onPress={this.onChange.bind(this, 0)} underlayColor='transparent'
                                        style={[styles.segPanel, styles[`segPanel${homeCss}`]]}>
                        <View style={styles.segPanelInner}>
                            ...
                            <TouchableHighlight onPress={this.onChange.bind(this, 1)} underlayColor='transparent'
                                                style={[styles.segPanel, styles[`segPanel${visitorCss}`]]}>
                                <View style={homeCss === 'Active' ? {
                                        backgroundColor: teamMap[homeAbb].color,
                                        height: 4
                                    } : {opacity: 0}}/>
                            </TouchableHighlight>
                        </View>
                    ...
                    <TouchableHighlight onPress={this.onChange.bind(this, 1)} underlayColor='transparent'
                        ...
                        <View style={styles.segPanelInner}>
                            ...
                            <View style={visitorCss === 'Active' ? {
                                    backgroundColor: teamMap[visitorAbb].color,
                                    height: 4
                                } : {opacity: 0}}/>
                        </View>
                    </TouchableHighlight>
