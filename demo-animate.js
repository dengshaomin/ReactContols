/**
 * Created by dengshaomin on 2017/3/16.
 */
            ...
            <View style={{margin: 20}}>
                ...
                {this.state.show && <FadeInView>
                    <View style={styles.content}>
                        <Image source={require('./img/ic_t_ren.png')} style={{width: 50, height: 50}}/>
                    </View>
                </FadeInView>}
                ...
                <Animated.View
                    ...
                    <Image source={require('./img/ic_t_xin.png')} style={{width: 50, height: 50}}/>
                </Animated.View>
